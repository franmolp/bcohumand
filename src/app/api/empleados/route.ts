...
export async function GET(request: NextRequest) {
  ...
  let query = supabase
    .from('usuarios')
    .select('id, usuario, reloj, nombre, email, estado_cuenta, foto_perfil, telefono, dni, fecha_nacimiento, ultimo_login, ultimo_acceso, ultimo_dispositivo, fecha_creacion, equipo:equipos(id,nombre), rol:roles(id,nombre)')
    .order('nombre')
